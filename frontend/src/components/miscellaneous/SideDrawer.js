      ...
      >
        <Tooltip label="Search Users to chat" hasArrow placement="bottom-end">
          <Button variant="ghost" bg ='blue.700' onClick={onOpen} color="white"
            _hover={{ background: "darkblue", color:"none" }} _active={{ background: "darkblue", color:"none" }}>
        ...
        <div>
          ...
          <Menu>
            <MenuButton as={Button} bg="darkblue"  rightIcon={<ChevronDownIcon/>}  
              _hover={{background: "darkblue", color:"white"}} _active={{background: "darkblue", color:"white"}}>
              <Avatar size="sm" cursor="pointer" name={user.name} borderColor="black" borderWidth="2px" bg="white" color="black"/>
            </MenuButton>
            <MenuList bg = "darkblue" borderColor="black" borderWidth="2px">
              <ProfileModal user={user}>
                <MenuItem fontWeight="bold" color="white" _hover={{background: "none"}}  >
                  My Profile
                </MenuItem>{" "}
              </ProfileModal>
              <MenuDivider/>
              <MenuItem fontWeight="bold" color="white" onClick={logoutHandler} _hover={{background: "none"}}>
                Logout
              </MenuItem>
            </MenuList>
          </Menu>
